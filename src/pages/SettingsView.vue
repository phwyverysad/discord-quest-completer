...
<template>
  <div class="max-w-6xl mx-auto w-full space-y-6 animate-fadeIn pb-12 select-none">
    ...
    <div class="flex items-center gap-2 overflow-x-auto pb-1 scrollbar-none">
      ...
      >
        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4c0-1.473 1.333-6 4-6s4 4.527 4 6a4 4 0 01-4 4zm0 0h10a4 4 0 004-4c0-2-1.5-3.5-3-3.5a1.5 1.5 0 00-1.5 1.5 2 2 0 01-4 0 5.5 5.5 0 00-5.5-5.5" />
        </svg>
